          ...
          <form method="post">
            <div class="wrapper">
                <div class="form2">
                  ...
                  <h1><input type = "submit"  class="button" value = "Register" >
                  <input type = "button" class="button" value = "Cancel" onclick="window.location.href = '../ITECT100B-Webpage/index.php';"></h1>
              </div>
            </div>  
