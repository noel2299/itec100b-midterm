    ...
    <div class="wrapper">
        <div class="form">
            ...
            <div class="container">
                ...
                <center> <button class="button" name="login" style="vertical-align:middle"><span>Login</span></center>
                       <a <button href="signup.php" class="button" style="vertical-align:middle"><span>Register</span></a>
                </center>
                <!--<button type="button"  class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" onclick="openWin()">Login</button>-->
                <br><br><br><br><h1><a href="../Activity4-SALGADO/forgot.php"> FORGOT PASSWORD </a></h1>           
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){ 
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $link = "<script>window.open('http://localhost/Activity4-SALGADO/authenticator.php')</script>"; 
                            echo $link; 
...
<?php
    ...
    if (isset($_POST['username'])){
        ...
        if($rows==1){
            ...
            header("location: ../Activity4-SALGADO/authenticator.php");
